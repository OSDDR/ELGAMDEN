...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ahmedosos1/ELGAMDEN/main/File_Bot/commands.lua") 
...
local UserName = (data.username_ or "mickey_osos")
...
os.execute('wget https://raw.githubusercontent.com/Ahmedosos1/ELGAMDEN/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ⚪ تم تحديث السورس \n ⚪ لديك اخر اصدار لسورس ميكي\n ⚪ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⚪ اصدار سورس ميكي \n ⚪ الاصدار »{ v 1.5}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/mickey_osos"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/TWASOL_MICKEYBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ⚪ العضو » ['..result.title_..'](t.me/'..(username or 'mickey_osos')..')'
status  = '\n ⚪ تم ترقيته مطور'
...
usertext = '\n ⚪ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'mickey_osos')..')'
status  = '\n ⚪ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚪ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'mickey_osos')..') \n ⚪ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⚪ العضو : {["..data.first_name_.."](T.ME/mickey_osos)}\n ⚪ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⚪ عذرا » {["..data.first_name_.."](T.ME/mickey_osos)}\n ⚪ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, [ ..TWEET_Msg[math.random(#TWEET_Msg)].. end
return false
...
keyboard.inline_keyboard = {
{{text = '𓆩OSOS𓆪',url="t.me/OSDDR"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/mickey_osos"}},
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/TWASOL_MICKEYBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⚪ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'mickey_osos')..') \n ⚪ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⚪ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'mickey_osos')..') \n ⚪ تـم قفـل التاك بالكتم ')
end,nil)   
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'mickey_osos')..')'
...
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 'mickey_osos')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ahmedosos1/ELGAMDEN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⚪ اهلا بك في متجر ملفات ميكي\n ⚪ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ\n ⚪ علامة تعني { ✔️ } ملف مفعل\n ⚪ علامة تعني { ✖ } ملف معطل\n ⚪ قناة سورس ميكي ↓\n".." ⚪ [اضغط هنا لدخول](t.me/mickey_osos) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ahmedosos1/ELGAMDEN/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⚪ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'mickey_osos')..')'
status  = '\n ⚪ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⚪ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⚪ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'mickey_osos')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⚪ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'mickey_osos')..')'..'\n ⚪ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."mickey_osos:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."mickey_osos:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."mickey_osos:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."mickey_osos:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⚪تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."mickey_osos:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."mickey_osos:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'mickey_osos')..')'
local iduser = result.sender_user_id_
...
{
{text = 'SOURCE MICKEY', url="t.me/mickey_osos"},
...
*ٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴ*
[ SOURCE MICKEY ](t.me/mickey_osos)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ MICKEY ┉  ┉ ┉ ┉ ┉≫ٴٴ\n⚪ [ SOURC MICKEY ](t.me/mickey_osos)')
end
...
◎⟼⟼⟼⟼⟼MICKEY⟻⟻⟻⟻⟻◎
[ 𝒔𝒐𝒖𝒓𝒄𝒆 mickey ](t.me/mickey_osos)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
